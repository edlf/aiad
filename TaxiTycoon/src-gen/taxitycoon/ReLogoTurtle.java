...
public class ReLogoTurtle extends BaseTurtle{
	...
	public AgentSet<taxitycoon.relogo.UserTurtle> hatchUserTurtles(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("taxitycoon.relogo.UserTurtle")
	public AgentSet<taxitycoon.relogo.UserTurtle> hatchUserTurtles(int number) {
	...
	public taxitycoon.relogo.UserLink createUserLinkFrom(Turtle t, Closure closure){
		taxitycoon.relogo.UserLink link = (taxitycoon.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(t,this);
		if (closure != null){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("taxitycoon.relogo.UserLink")
	public taxitycoon.relogo.UserLink createUserLinkFrom(Turtle t){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("taxitycoon.relogo.UserLink")
	public AgentSet<taxitycoon.relogo.UserLink> createUserLinksFrom(Collection<? extends Turtle> a, Closure closure){
		AgentSet<taxitycoon.relogo.UserLink> links = new AgentSet<taxitycoon.relogo.UserLink>();
		for(Turtle t : a){
			links.add((taxitycoon.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(t,this));
		}
		if (closure != null){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("taxitycoon.relogo.UserLink")
	public AgentSet<taxitycoon.relogo.UserLink> createUserLinksFrom(Collection<? extends Turtle> a){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("taxitycoon.relogo.UserLink")
	public taxitycoon.relogo.UserLink createUserLinkTo(Turtle t, Closure closure){
		taxitycoon.relogo.UserLink link = (taxitycoon.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(this,t);
		if (closure != null){
			this.ask(link,closure);
		}
		return link;
	 ...
	 */
	@ReLogoBuilderGeneratedFor("taxitycoon.relogo.UserLink")
	public taxitycoon.relogo.UserLink createUserLinkTo(Turtle t){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("taxitycoon.relogo.UserLink")
	public AgentSet<taxitycoon.relogo.UserLink> createUserLinksTo(Collection<? extends Turtle> a, Closure closure){
		AgentSet<taxitycoon.relogo.UserLink> links = new AgentSet<taxitycoon.relogo.UserLink>();
		for(Object t : a){
			if (t instanceof Turtle){
				links.add((taxitycoon.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(this,(Turtle)t));
			}
		}
		if (closure != null){
			this.ask(links,closure);
	 ...
	 */
	@ReLogoBuilderGeneratedFor("taxitycoon.relogo.UserLink")
	public AgentSet<taxitycoon.relogo.UserLink> createUserLinksTo(Collection<? extends Turtle> a){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("taxitycoon.relogo.UserLink")
	public taxitycoon.relogo.UserLink inUserLinkFrom(Turtle t){
		return (taxitycoon.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").getEdge(t,this);
	}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("taxitycoon.relogo.UserLink")
	public AgentSet<taxitycoon.relogo.UserLink> myInUserLinks(){
		AgentSet<taxitycoon.relogo.UserLink> result = new AgentSet<taxitycoon.relogo.UserLink>();
		for(Object o :  this.getMyObserver().getNetwork("UserLink").getInEdges(this)){
			if (o instanceof taxitycoon.relogo.UserLink){
				result.add((taxitycoon.relogo.UserLink) o);
			}
		}
		return result;
	}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("taxitycoon.relogo.UserLink")
	public AgentSet<taxitycoon.relogo.UserLink> myOutUserLinks(){
		AgentSet<taxitycoon.relogo.UserLink> result = new AgentSet<taxitycoon.relogo.UserLink>();
	 ...
	 */
	@ReLogoBuilderGeneratedFor("taxitycoon.relogo.UserLink")
	public taxitycoon.relogo.UserLink outUserLinkTo(Turtle t){
		return (taxitycoon.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").getEdge(this, t);
	}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("taxitycoon.relogo.UserLink")
	public AgentSet<taxitycoon.relogo.UserLink> myUserLinks(){
		AgentSet<taxitycoon.relogo.UserLink> result = new AgentSet<taxitycoon.relogo.UserLink>();
