...
/**
 * Note: this class, as all classes in the <code>sajas.core.behaviours</code> package,
 * has been re-implemented to redirect the use of the agent class to <code>sajas.core.Agent</code>.
 * 
...
public abstract class Behaviour implements Serializable {
	 ...
	 * it is strongly suggested to use this method rather than the <code>parent</code> member variable
